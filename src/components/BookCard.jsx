    ...
    return (
        <div className="bg-white border border-gray-200 rounded-lg shadow-md overflow-hidden transition-transform transform hover:scale-105">
            ...
            <div className="p-4">
                ...
                <p className="text-gray-700 text-lg font-medium mt-1"><span className='font-semibold'>Author:</span> {book.authors.map(author => author.name).join(', ')}</p>
                <p className="text-gray-500 mt-1"><span className='font-semibold text-gray-700'>Genre:</span> {book.subjects.join(', ')}</p>
                <p className="text-gray-500 mt-1"><span className='font-semibold text-gray-700'>Id:</span> {book.id}</p>
